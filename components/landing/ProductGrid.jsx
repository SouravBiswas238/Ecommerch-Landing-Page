...
const SkeletonCard = () => (
  <div
    className="bg-white rounded-2xl p-4 border flex gap-4 animate-pulse"
...
const ProductGrid = ({
  ...
  if (filteredProducts?.length === 0) {
    ...
    return (
      <div
        className="bg-white rounded-2xl border p-12 text-center max-w-md mx-auto space-y-4"
        style={{ borderColor: "var(--color-border)" }}
      >
        <div
        ...
        <div>
          ...
          >
            {hasActiveFilters ? "No matches found" : "No menu items available"}
          </h4>
            ...
            <div className="flex flex-col justify-between flex-1 min-w-0">
              <div>
                <div className="flex items-start justify-between gap-1 mb-1">
                  <h3
                    className="font-extrabold text-sm md:text-base leading-tight truncate transition-colors"
                    style={{ color: "var(--color-secondary)" }}
                    onMouseEnter={(e) => {
                ...
                >
                  {product.description ||
                    "Freshly cooked specialty, prepared with local premium ingredients and served warm."}
                </p>
              </div>
              ...
              <div className="flex items-center justify-between gap-2 mt-auto">
                ...
                {hasOptions ? (
                  ...
                  <div
                    className="flex items-center rounded-full p-1 shadow-md z-10"
                    style={{
                      background: "var(--color-primary)",
                      boxShadow:
