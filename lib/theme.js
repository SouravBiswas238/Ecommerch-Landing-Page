...
const DEFAULTS = {
  primary: "#5F359F", // purple  – buttons, active states
  primaryHover: "#7649FD",
  secondary: "#003660", // navy    – headings, dark text
  accent: "#FFDF00", // yellow  – badges, highlights
  bg: "#FDF8F6", // warm off-white page background
  surface: "#FFFFFF", // card / panel background
  border: "#E5E7EB", // light border
  muted: "#808080", // secondary text
  bodyText: "#374151", // body text
  danger: "#dc3545", // error / remove
