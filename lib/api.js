 ...
 * @param {{name?: string, phone?: string}} [attributes] - Known customer info from a prior order, if any
 */
export const trackVisit = async (companyId, visitorId, attributes) => {
  const response = await axios.post(
    `${getServerLink()}/company/company-visitor`,
    {
